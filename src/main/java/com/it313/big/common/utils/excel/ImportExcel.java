...
public class ImportExcel {
	...
	public <E> List<E> getDataList(Class<E> cls, int... groups) throws InstantiationException, IllegalAccessException{
		...
		for (int i = this.getDataRowNum(),len=this.getLastDataRowNum(); i < len; i++) {
	...
	public Map<String, PictureData> getPicList() throws InvalidFormatException, IOException {
     ...
     * @throws IOException 
     */  
    public Map<String, PictureData> getSheetPictrues03(HSSFSheet sheet, HSSFWorkbook workbook) {  
...
//                            + String.valueOf(anchor.getCol1());  
     ...
     * @return Map key:图片单元格索引（0_1_1）String，value:图片流PictureData 
     */  
    public Map<String, PictureData> getSheetPictrues07(XSSFSheet sheet, XSSFWorkbook workbook) {  
        Map<String, PictureData> sheetIndexPicMap = new HashMap<String, PictureData>();  
